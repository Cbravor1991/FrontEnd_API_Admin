...
const ShowsAllPublications = ({ filters }) => {
  ...
  const loadPublications = () => {
    ...
    axios.post('/getRecommendationByLocation', {}, { params })
      .then((response) => {
        console.log('entro_aca')

        province = response.data[0].Property.province
        console.log(province)

        params = new URLSearchParams([['offset', 0], ['limit', 4]]);
